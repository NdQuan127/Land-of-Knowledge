---
{"dg-publish":true,"permalink":"/encounters/ket-noi-firefox-voi-ung-dung-ngoai-de-mo-tai-video-playlist-bang-mpv-yt-dlp/"}
---
...
- Chỉ dùng cho Floorp: [[+ Encounters/Hướng dẫn sử dụng handlers.json mà ko cần cài addon\|Hướng dẫn sử dụng handlers.json mà ko cần cài addon]]
- Các bản firefox khác: [[+ Encounters/Addon External Application\|Addon External Application]] *(do cũng chưa test thử nên nếu anh em nào đang dùng các bản khác có thể làm thử bằng cái handler kia xem)*
- [[+ Encounters/Userscript lấy link video để xem trong MPV\|Userscript lấy link video để xem trong MPV]]
- [[+ Encounters/Usercript mở video trên youtube bằng cách click vào thumbnail\|Usercript mở video trên youtube bằng cách click vào thumbnail]]
